...
class TimeTableViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBOutlet weak var TimeTableTitle: UINavigationItem!
    @IBOutlet weak var scrollView: UIScrollView!
    
    var TimeTableReceiveData: String = ""
    var TimeTableTitleReceiveData: String = ""
    ...
    override func viewDidLoad() {
        ...
        TimeTableTitle.title = TimeTableTitleReceiveData
        ...
        imageView.image = UIImage(named: TimeTableReceiveData)
